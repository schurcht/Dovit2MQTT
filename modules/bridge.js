...
export default class Bridge {
    ...
    async __handleBridgeUpdate() {
        ...
        this.mqtt.publish(`${this.config.mqtt.topic}/bridge/devices`, JSON.stringify(this.devices), { retain: true })
        this.mqtt.publish(`${this.config.mqtt.topic}/bridge/state`, JSON.stringify({ state: "online" }), { retain: true })
    }
